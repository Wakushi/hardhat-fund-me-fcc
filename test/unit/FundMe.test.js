...
describe("FundMe", async function () {
    ...
    beforeEach(async function () {
        ...
        // they can be used when testing. getSigners() returns an array of theses accounts.
    ...
    describe("Fund", async function () {
        ...
        it("adds funder to array of funders", async function () {
            await fundMe.fund({ value: sendValue })
            // The syntax funders(0) acts as a getter function, instead of saying funders[0],
            // we have to use this syntax to get the first index.
    ...
    describe("Withdraw", async function () {
        ...
        it("allows us to withdraw with multiple funders", async function () {
            ...
            // Make sure that the funders get reset properly
    ...
    describe("receive() and fallback()", function () {
        it("should fund the contract with receive()", async function () {
            ...
            // -> fundMe.addressToAmountFunded(address)
            const initialBalance = await fundMe.addressToAmountFunded(
                funder.address
            )
            ...
            const finalBalance = await fundMe.addressToAmountFunded(
                funder.address
            )
            expect(finalBalance).to.equal(initialBalance.add(fundingAmount))
        })
